...
function SWEP:doSocomConversionStats()
    ...
    local bSup5 = self:HasAttachment("attachment_vm_ar_t9standard_barsil")
    local bSup6 = self:HasAttachment("attachment_vm_ar_t9standard_mag_v5")
    local bSup6 = self:HasAttachment("attachment_vm_ar_t9standard_barrel_v7")
...
SWEP.Customization = {
    ...
    {"att_laser", "attachment_vm_ar_t9standard__laser01_cylinder", "attachment_vm_ar_t9standard__laser02_cylinder", 
    "attachment_vm_ar_t9standard__laser03_cylinder"},
    ...
    "attachment_vm_ar_t9standard_vertgrip03"},
}
...
--         Slot = 2,
--         {
--             Key = "attachment_vm_ar_t9standard_barrel",
--             Bodygroups = {
--                 ["tag_grip_hide"] = 1
--             },
--             Stats = function(self)
...
--         },
--         {
--             Key = "attachment_vm_ar_t9standard_mike203barrel",
--             Bodygroups = {
--                 ["barrel_tip"] = 4,
--                 ["tag_sight_barrel"] = 6,
--                 ["tag_grip_hide"] = 1
...
--         },
--         {
--             Key = "attachment_vm_ar_t9standard_shortbarrel",
--             Bodygroups = {
--                 ["barrel_tip"] = 8,
--                 ["tag_sight_barrel"] = 8,
--                 ["tag_grip_hide"] = 1
...
--         },
--         {
--             Key = "attachment_vm_ar_t9standard_custombarrel",
--             Bodygroups = {
--                 ["barrel_tip"] = 4,
--                 ["tag_sight_barrel"] = 4,
--                 ["tag_laser_hide"] = 0,
...
--         },
--         {
--             Key = "attachment_vm_ar_t9standard_barrel_v3_alt",
--             Bodygroups = {
--                 ["barrel_tip"] = 0,
--                 ["tag_sight_barrel"] = 2,
--                 ["tag_grip_hide"] = 1
...
--         },
--         {
--             Key = "attachment_vm_ar_t9standard_barsil",
--             Bodygroups = {
--                 ["barrel_tip"] = 8,
--                 ["tag_sight_barrel"] = 2,
--                 ["tag_grip_hide"] = 1
...
--         },
--         {
--             Key = "attachment_vm_ar_t9standard_carryhandle",
--             Bodygroups = {
--                 ["tag_sight"] = 2
--             },
--             Stats = function(self)
...
--         Slot = 7,
--         {
--             Key = "attachment_vm_ar_t9standard_stock",
--             Stats = function(self)
--             end
--         },
--         {
--             Key = "attachment_vm_ar_t9standard_customstock",
--             Stats = function(self)
--             end
--         },
--         {
...
--         },
--         {
--             Key = "attachment_vm_ar_t9standard_stockno",
--             Bodygroups = {
--                 ["stock_hide"] = 1
--             },
--             Stats = function(self)
...
--         Slot = 5,
--         {
--             Key = "attachment_vm_ar_t9standard_mag",
--             Stats = function(self)
--             end
--         },
--         {
--             Key = "attachment_vm_ar_t9standard_calsmg",
--             Bodygroups = {
--                 ["ejection_cover"] = 1,
--                 ["tag_mag_show"] = 1
--             },
...
--         },
--         {
--             Key = "attachment_vm_ar_t9standard_xmags",
--             Stats = function(self)
--             end
--         },
--         {
--             Key = "attachment_vm_ar_t9standard_xmags2",
--             Stats = function(self)
--             end
--         },
--         {
--             Key = "attachment_vm_ar_t9standard_mag_v5",
--             Stats = function(self)
--             end
--         }
--     },
